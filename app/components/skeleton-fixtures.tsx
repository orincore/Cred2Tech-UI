  ...
  return (
    ...
    >
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute right-[4%] top-[22%] h-56 w-56 rounded-full bg-[var(--on-surface)] blur-3xl" />
      ...
      <SectionShell className="relative z-10 grid min-h-screen grid-cols-1 items-center gap-8 pt-28 pb-16 lg:grid-cols-2 lg:gap-12">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 h-5 w-40 rounded-full bg-[var(--on-surface)]/30" aria-label={eyebrow} />
          ...
          <div className="mt-10 flex flex-col gap-3 sm:flex-row">
            <div className="h-12 w-56 rounded-full bg-[var(--on-surface)]/55" />
        ...
        <div className="mx-auto w-full max-w-[380px] rounded-[28px] border border-white/10 bg-white/8 p-4 shadow-[0_32px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl">
          ...
          <div className="space-y-4 py-4">
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 rounded-2xl bg-[var(--on-surface)]/20" />
          ...
          <div className="border-t border-white/10 pt-4">
            <div className="h-3 w-40 rounded-full bg-[var(--on-surface)]/30" />
          </div>
        </div>
      </SectionShell>
    </section>
  ...
  return (
    <AuthCardShell
      sidePanel={
        <div className="relative z-10 flex h-[440px] w-[440px] items-center justify-center">
          <div className="h-72 w-72 rounded-full bg-gradient-to-tr from-[#3b82f6]/20 to-[var(--on-surface)]/10 blur-3xl" />
    ...
    >
      ...
      <div className="mt-6 space-y-4">
        ...
        <div className="h-12 rounded-[10px] bg-[var(--on-surface)]" />
      </div>
    </AuthCardShell>
  );
}
  ...
  return (
    ...
    >
      ...
      <div className="mt-8 space-y-4">
        ...
        <div className="h-12 rounded-[10px] bg-[#f6f3f2]" />
        <div className="h-[54px] rounded-[10px] bg-[var(--on-surface)]" />
      </div>
