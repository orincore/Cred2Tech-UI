        ...
        <div className="col-span-2 sm:col-span-2 space-y-3">
          ...
          <div className="flex items-center gap-2.5">
            {[
              ...
              <a key={social.label} href="#" className="w-7 h-7 flex items-center justify-center bg-[var(--on-surface)]/[0.05] text-[var(--on-surface)] rounded-full hover:bg-[var(--on-surface)] hover:text-[var(--bg)] transition-all duration-300" aria-label={social.label}>
