  ...
  return (
    <main className="bg-[#fcf9f8] text-[#1b1c1c] font-(family-name:--font-inter)">
      ...
      >
        ...
        <div className="hidden lg:block px-orb w-[300px] h-[300px] bg-[var(--accent)] absolute bottom-[-80px] right-[5%] z-0" />
        ...
        <div className="w-full max-w-[900px] mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 relative z-10">
          ...
          <span className="inline-block font-(family-name:--font-jb-mono) text-xs font-bold tracking-[0.18em] uppercase text-[var(--accent)] mb-4 px-3 py-1 border border-[var(--accent)]/30 bg-[var(--accent)]/10">
        ...
        <div className="w-full max-w-[760px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {post.sections.map((section, i) => (
            <div key={i} className="mb-8">
              {section.heading && (
                <h2 className="font-(family-name:--font-outfit) text-2xl sm:text-3xl font-bold text-[var(--primary)] mb-4 mt-4">
                  {section.heading}
                </h2>
              )}
              {section.sub && (
                <h3 className="font-(family-name:--font-outfit) text-lg sm:text-xl font-semibold text-[var(--primary-c)] mb-3">
                  {section.sub}
                </h3>
              )}
          ...
          <div className="mt-10 pt-8 border-t border-[#e8e4e1]">
            <h2 className="font-(family-name:--font-outfit) text-2xl sm:text-3xl font-bold text-[var(--primary)] mb-4">Conclusion</h2>
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-3">
            <Link href="/blogs" className="inline-flex items-center justify-center gap-1.5 border-2 border-[var(--primary)]/25 text-[var(--primary)] px-5 py-2.5 sm:px-6 sm:py-3 font-bold text-sm hover:bg-[var(--primary)]/5 hover:border-[var(--primary)]/50 transition-all">
              Back to all articles
            </Link>
            <Link href="/contact" className="inline-flex items-center justify-center gap-1.5 bg-[var(--primary)] text-white px-5 py-2.5 sm:px-6 sm:py-3 font-bold text-sm hover:bg-[var(--primary-c)] transition-all">
              Talk to the team
            </Link>
          </div>
        </div>
