        ...
        <div className="w-full max-w-[800px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <form onSubmit={handleSubmit} className="bg-[#fcf9f8] border border-[#e8e4e1] p-6 sm:p-8 lg:p-10">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="sm:col-span-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white border border-[#e8e4e1] text-[#1b1c1c] focus:border-[var(--primary)] focus:outline-none transition-colors"
              ...
              {/* Business Name */}
              <div className="sm:col-span-2">
                <label className="block text-sm font-semibold text-[var(--primary)] mb-2">Business Name</label>
                <input
                  type="text"
              ...
              {/* Mobile Number */}
              <div>
                <label className="block text-sm font-semibold text-[var(--primary)] mb-2">Mobile Number</label>
                <input
                  type="tel"
              ...
              {/* Email Address */}
              <div>
                <label className="block text-sm font-semibold text-[var(--primary)] mb-2">Email Address</label>
                <input
                  type="email"
              ...
              {/* I am a... */}
              <div>
                <label className="block text-sm font-semibold text-[var(--primary)] mb-2">I am a...</label>
                <div className="relative">
                  <select
                    value={formData.role}
                    onChange={(e) => setFormData({...formData, role: e.target.value})}
                    className="w-full px-4 py-3 bg-white border border-[#e8e4e1] text-[#1b1c1c] focus:border-[var(--primary)] focus:outline-none transition-colors appearance-none cursor-pointer pr-10"
                    required
                  >
                  ...
                  <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none">
                    <svg className="w-5 h-5 text-[var(--primary)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m6 9 6 6 6-6"/></svg>
                  </div>
                </div>
              </div>
              ...
              {/* How can we help? */}
              <div>
                <label className="block text-sm font-semibold text-[var(--primary)] mb-2">How can we help?</label>
                <div className="relative">
                  <select
              ...
              {/* Message */}
              <div className="sm:col-span-2">
                <label className="block text-sm font-semibold text-[var(--primary)] mb-2">Message (optional)</label>
                <textarea
                  value={formData.message}
                  onChange={(e) => setFormData({...formData, message: e.target.value})}
                  rows={4}
                  maxLength={500}
                  className="w-full px-4 py-3 bg-white border border-[#e8e4e1] text-[#1b1c1c] focus:border-[var(--primary)] focus:outline-none transition-colors resize-none"
            ...
            <div className="mt-8">
              <button
                type="submit"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[var(--accent)] text-[#001233] px-8 py-4 font-bold text-sm sm:text-base hover:shadow-[0_0_28px_rgba(29,255,155,0.5)] hover:scale-[1.02] transition-all group"
              >
      ...
      <section id="contact-details" className="py-10 sm:py-12 lg:py-16 bg-[#f0f7ff] relative overflow-hidden">
        ...
        <div className="w-full max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {/* Email */}
            <div className="contact-card bg-[#fcf9f8] border border-[#e8e4e1] p-6 transition-all duration-300 hover:border-[var(--primary)]/30 hover:shadow-[0_20px_60px_rgba(0,63,125,0.08)]">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 bg-[var(--primary)]/5 flex items-center justify-center">
                  <span className="material-symbols-outlined text-[var(--primary)]">email</span>
                </div>
                <h3 className="font-(family-name:--font-outfit) text-lg font-semibold text-[var(--primary)]">Email</h3>
              </div>
              <a href="mailto:contact@cred2tech.com" className="text-sm text-[#424751] hover:text-[var(--primary)] transition-colors break-all">
            ...
            <div className="contact-card bg-[#fcf9f8] border border-[#e8e4e1] p-6 transition-all duration-300 hover:border-[var(--primary)]/30 hover:shadow-[0_20px_60px_rgba(0,63,125,0.08)]">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 bg-[var(--primary)]/5 flex items-center justify-center">
                  <span className="material-symbols-outlined text-[var(--primary)]">phone</span>
                </div>
                <h3 className="font-(family-name:--font-outfit) text-lg font-semibold text-[var(--primary)]">Phone</h3>
              </div>
              <div className="space-y-1">
                <a href="tel:+918867522242" className="block text-sm text-[#424751] hover:text-[var(--primary)] transition-colors">
                  +91 8867522242
                </a>
                <a href="tel:+919886401608" className="block text-sm text-[#424751] hover:text-[var(--primary)] transition-colors">
                  +91 9886401608
                </a>
              </div>
            </div>
            ...
            <div className="contact-card bg-[#fcf9f8] border border-[#e8e4e1] p-6 transition-all duration-300 hover:border-[var(--primary)]/30 hover:shadow-[0_20px_60px_rgba(0,63,125,0.08)]">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-(family-name:--font-outfit) text-lg font-semibold text-[var(--primary)]">Response Time</h3>
              </div>
            ...
            {/* Registered Office */}
            <div className="contact-card sm:col-span-2 lg:col-span-2 bg-[#fcf9f8] border border-[#e8e4e1] p-6 transition-all duration-300 hover:border-[var(--primary)]/30 hover:shadow-[0_20px_60px_rgba(0,63,125,0.08)]">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 bg-[var(--primary)]/5 flex items-center justify-center">
                  <span className="material-symbols-outlined text-[var(--primary)]">location_on</span>
                </div>
                <h3 className="font-(family-name:--font-outfit) text-lg font-semibold text-[var(--primary)]">Registered Office</h3>
              </div>
              <p className="text-sm text-[#424751]">
            ...
            <div className="contact-card bg-[#fcf9f8] border border-[#e8e4e1] p-6 transition-all duration-300 hover:border-[var(--primary)]/30 hover:shadow-[0_20px_60px_rgba(0,63,125,0.08)]">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 bg-[var(--primary)]/5 flex items-center justify-center">
                  <span className="material-symbols-outlined text-[var(--primary)]">link</span>
                </div>
                <h3 className="font-(family-name:--font-outfit) text-lg font-semibold text-[var(--primary)]">LinkedIn</h3>
              </div>
              <a 
                href="https://linkedin.com/company/cred2tech" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-sm text-[#424751] hover:text-[var(--primary)] transition-colors break-all"
              >
